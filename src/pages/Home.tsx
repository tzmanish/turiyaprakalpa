...
const Home = () => {
    ...
    return (
        <div className="container mx-auto my-12 flex flex-col gap-[10rem]">
            ...
            <section className="text-center flex flex-col gap-10">
                ...
                <div className="flex gap-4 justify-center">
                    <Button customClasses='text-base-white'>
                        Join the Cohort
                        <ArrowRight />
                    </Button>
                    <Button customClasses='bg-transparent border-3 border-primary text-primary hover:bg-transparent backdrop-blur-sm'>Become a Partner</Button>
                </div>

                <div className="flex flex-col items-center">
                    <h3 className="text-2xl font-semibold mb-4">Next Cohort Starting Soon</h3>
                    <div className="grid grid-cols-4 gap-4 p-6 rounded-xl backdrop-blur-sm shadow-lg bg-base-white/20">
                        <div className="text-center">
                            <div className="bg-secondary rounded-xl p-4 mb-2 aspect-square flex items-center justify-center">
                        ...
                        <div className="text-center">
                            <div className="bg-secondary rounded-lg p-4 mb-2 aspect-square flex items-center justify-center">
            ...
            <section className="text-center flex flex-col gap-10">
                ...
                <div className="bg-primary/85 backdrop-blur-sm p-12 rounded-3xl flex flex-col gap-6 shadow-lg">
                    <h2 className="text-4xl font-bold text-base-white">
                        The AI Era Demands More Than Code.
                    </h2>
                    <h3 className="text-4xl font-bold text-secondary">
                        It Demands Problem-Solvers.
                    </h3>
                    <p className="text-lg text-base-white">
                    ...
                    <div className="flex gap-4 justify-center">
                        ...
                        <Button customClasses='bg-secondary hover:bg-dark-secondary'>
                            Become a Partner
                        </Button>
                    </div>
                </div>
                ...
                <div className="text-center flex flex-col gap-6">
                    ...
                    <p className="text-lg">
                        The future belongs to those who can identify the right problems and build solutions.
                        <br />
                        AI is just the tool.
                        <br />
                ...
                <div className="grid grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <div key={index} className="p-8 rounded-xl border-3 backdrop-blur-sm shadow-lg bg-base-white/20 border-secondary transition-all hover:scale-105 text-center flex flex-col gap-4">
            ...
            <section className="text-center flex flex-col gap-10">
                ...
                <div className="grid grid-cols-4 gap-8">
                    {journeySteps.map((step, index) => (
                        <div key={index} className="backdrop-blur-sm shadow-lg p-6 rounded-xl bg-base-white/20 border-3 transition-all hover:scale-105 border-primary text-center flex flex-col gap-4 item-center">
                            <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-base-white font-bold text-2xl mx-auto">
                                {step.number}
                            </div>
            ...
            <section className="text-center flex flex-col gap-10">
                ...
                <div className="shadow-lg backdrop-blur-sm p-8 rounded-2xl flex flex-col gap-8 bg-secondary/70 text-base-white">
                    ...
                    <div className="flex flex-row gap-4 justify-center">
                        <Button bg={true}>🚀 Secure Your Spot</Button>
            ...
            <section className="text-center flex flex-col gap-10">
                <div className="text-center">
                    ...
                    <p className="text-lg">Institutions, Ecosystem Partners, Experts</p>
                </div>

                <div className="grid grid-cols-2 gap-10 items-center">
                    <div className='flex flex-col gap-4 items-center'>
                        <h3 className="text-4xl font-bold">Indore Tech Synergy Fest</h3>
                        <p className="text-lg">
                    ...
                    <div className="backdrop-blur-sm p-8 rounded-xl shadow-lg bg-base-white/20">
